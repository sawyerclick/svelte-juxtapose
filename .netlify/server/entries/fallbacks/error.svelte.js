...
const getStores = () => {
  const stores = (0, import_chunks.g)("__svelte__");
...
const Error$1 = (0, import_chunks.c)(($$result, $$props, $$bindings, slots) => {
  let $page, $$unsubscribe_page;
  $$unsubscribe_page = (0, import_chunks.b)(page, (value) => $page = value);
  $$unsubscribe_page();
